    ...
    <div className="min-h-screen bg-[#F5EFEB] text-[#183B56] font-sans pb-20 select-none">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-20 text-center">
        ...
        <p className="text-[12px] text-[#2B2B2B]/55 font-medium leading-relaxed mb-6">
          If you have questions about how we handle data, or want to make a request, shoot us a mail at <a href="mailto:privacy@Weavly.com" className="text-[#F07020] underline font-bold">privacy@Weavly.com</a>.
        </p>
