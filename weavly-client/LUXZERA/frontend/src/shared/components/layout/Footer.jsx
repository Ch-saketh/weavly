...
export default function Footer({ onShopNow, onBetaClick, requireAuth, onRequireAuth }) {
  ...
  return (
    <footer className="relative w-full bg-[#000000] text-white font-sans select-none overflow-hidden border-t border-[#1F1F23]">
      
      {/* ═══ 1. MONOCHROME ATMOSPHERIC DEPTH GRADIENT ═══ */}
      <div 
        className="absolute inset-0 pointer-events-none"
        style={{
          background: "radial-gradient(ellipse 90% 70% at 20% -10%, #18181B 0%, #0D0D0E 45%, #000000 85%)",
        }}
      />

      {/* ═══ 2. SOFT MONOCHROME CHARCOAL BLOOMS ═══ */}
      <div 
        className="absolute -top-24 -left-20 w-[480px] h-[380px] rounded-full blur-[140px] pointer-events-none opacity-20"
        style={{ background: "#27272A" }}
      />
      <div 
        className="absolute top-12 left-1/3 w-[520px] h-[400px] rounded-full blur-[160px] pointer-events-none opacity-15"
        style={{ background: "#3F3F46" }}
      />
      <div 
        className="absolute -top-16 -right-16 w-[420px] h-[360px] rounded-full blur-[150px] pointer-events-none opacity-15"
        style={{ background: "#27272A" }}
      />
      <div 
        className="absolute -bottom-10 left-1/4 w-[650px] h-[220px] rounded-full blur-[130px] pointer-events-none opacity-20"
        style={{ background: "#1C1C1F" }}
      />

      {/* ═══ 3. TACTILE NOISE / FINE-GRAIN TEXTURE OVERLAY (3-5% Opacity) ═══ */}
      <div 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <button
                onClick={() => {}}
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#18181B] hover:bg-[#27272A] border border-[#27272A] hover:border-[#3F3F46] text-[#E4E4E7] text-[12px] font-medium transition-all duration-200 cursor-pointer shadow-sm group"
              >
              ...
              {/* Minimal Monochrome Social Media Capsule Buttons */}
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="w-8 h-8 rounded-full bg-[#18181B] hover:bg-[#27272A] border border-[#27272A] hover:border-[#3F3F46] flex items-center justify-center text-[#A1A1AA] hover:text-white transition-all duration-200 hover:scale-105"
                >
